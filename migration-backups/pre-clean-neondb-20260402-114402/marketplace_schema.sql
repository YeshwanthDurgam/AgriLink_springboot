...
\restrict nQViFEzh6dLi7VOp0Zaf1hOcKOxSOC6c1bwIC36OFHkP8Ki65hV0MbIcXBsdVny
...
CREATE INDEX idx_listings_crop_type_trgm ON marketplace_schema.listings USING gin (lower((COALESCE(crop_type, ''::character varying))::text) marketplace_schema.gin_trgm_ops);
...
CREATE INDEX idx_listings_description_trgm ON marketplace_schema.listings USING gin (lower(COALESCE(description, ''::text)) marketplace_schema.gin_trgm_ops);
...
CREATE INDEX idx_listings_title_trgm ON marketplace_schema.listings USING gin (lower((title)::text) marketplace_schema.gin_trgm_ops);
...
\unrestrict nQViFEzh6dLi7VOp0Zaf1hOcKOxSOC6c1bwIC36OFHkP8Ki65hV0MbIcXBsdVny
