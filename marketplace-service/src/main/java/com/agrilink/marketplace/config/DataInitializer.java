...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        try {
            ...
            // Check if listings already exist (categories may be created by Flyway migration)
            if (listingRepository.count() > 0) {
                log.info("Listings already exist, skipping initialization");
                return;
            }

            // Fetch or create categories
            Category vegetables = getOrCreateCategory("Vegetables", "Fresh vegetables from local farms");
            Category fruits = getOrCreateCategory("Fruits", "Fresh fruits and berries");
            Category grains = getOrCreateCategory("Grains", "Rice, wheat, corn and other grains");
            Category dairy = getOrCreateCategory("Dairy", "Milk, cheese, and dairy products");
            Category organic = getOrCreateCategory("Organic", "Certified organic produce");
            Category spices = getOrCreateCategory("Spices", "Fresh and dried spices");
            Category pulses = getOrCreateCategory("Pulses", "Lentils, beans, and legumes");

            log.info("Found/Created {} categories", categoryRepository.count());

            // Create sample listings with images for all profiles including docker
            createSampleListings(vegetables, fruits, grains, dairy, organic, spices, pulses);
    ...
    private void createSampleListings(Category vegetables, Category fruits, Category grains, Category dairy, Category organic, Category spices, Category pulses) {
        ...
        createListing(FARMER1_ID, vegetables, "Fresh Organic Tomatoes",
            ...
            "Tomato", new BigDecimal("150.00"), new BigDecimal("55.00"), new BigDecimal("2.00"),
        ...
        createListing(FARMER1_ID, vegetables, "Crispy Lettuce Mix",
            ...
            "Lettuce", new BigDecimal("75.00"), new BigDecimal("80.00"), new BigDecimal("1.00"),
            "Green Valley Farm, California", true, "A+",
        ...
        createListing(FARMER1_ID, vegetables, "Fresh Spinach Bundle",
            ...
            "Spinach", new BigDecimal("60.00"), new BigDecimal("60.00"), new BigDecimal("0.50"),
            "Green Valley Farm, California", true, "A",
        ...
        createListing(FARMER1_ID, vegetables, "Organic Bell Peppers",
            ...
            "Bell Pepper", new BigDecimal("80.00"), new BigDecimal("120.00"), new BigDecimal("1.00"),
            "Green Valley Farm, California", true, "A",
        ...
        createListing(FARMER1_ID, vegetables, "Fresh Broccoli",
            ...
            "Broccoli", new BigDecimal("45.00"), new BigDecimal("90.00"), new BigDecimal("1.00"),
            "Green Valley Farm, California", true, "A",
        ...
        createListing(FARMER1_ID, vegetables, "Organic Cucumbers",
            ...
            "Cucumber", new BigDecimal("90.00"), new BigDecimal("35.00"), new BigDecimal("2.00"),
            "Green Valley Farm, California", true, "A",
        ...
        createListing(FARMER1_ID, fruits, "Sweet Strawberries",
            ...
            "Strawberry", new BigDecimal("40.00"), new BigDecimal("280.00"), new BigDecimal("0.50"),
            "Green Valley Farm, California", true, "A",
        ...
        createListing(FARMER1_ID, fruits, "Fresh Blueberries",
            ...
            "Blueberry", new BigDecimal("25.00"), new BigDecimal("450.00"), new BigDecimal("0.25"),
            "Green Valley Farm, California", true, "A+",
        ...
        createListing(FARMER1_ID, fruits, "Organic Avocados",
            ...
            "Avocado", new BigDecimal("50.00"), new BigDecimal("180.00"), new BigDecimal("3.00"),
            "Green Valley Farm, California", true, "A",
        ...
        createListing(FARMER1_ID, dairy, "Farm Fresh Eggs",
            ...
            "Eggs", new BigDecimal("200.00"), new BigDecimal("85.00"), new BigDecimal("1.00"),
        ...
        createListing(FARMER1_ID, dairy, "Fresh Goat Cheese",
            ...
            "Cheese", new BigDecimal("15.00"), new BigDecimal("650.00"), new BigDecimal("0.25"),
        ...
        createListing(FARMER2_ID, grains, "Premium Basmati Rice",
            ...
            "Rice", new BigDecimal("500.00"), new BigDecimal("120.00"), new BigDecimal("5.00"),
        ...
        createListing(FARMER2_ID, grains, "Organic Wheat Flour",
            ...
            "Wheat", new BigDecimal("300.00"), new BigDecimal("48.00"), new BigDecimal("5.00"),
        ...
        createListing(FARMER2_ID, grains, "Yellow Corn",
            ...
            "Corn", new BigDecimal("200.00"), new BigDecimal("38.00"), new BigDecimal("10.00"),
        ...
        createListing(FARMER2_ID, grains, "Organic Oats",
            ...
            "Oats", new BigDecimal("150.00"), new BigDecimal("95.00"), new BigDecimal("2.00"),
            "Sunrise Farm, Texas", true, "A",
        ...
        createListing(FARMER2_ID, vegetables, "Fresh Carrots",
            ...
            "Carrot", new BigDecimal("200.00"), new BigDecimal("45.00"), new BigDecimal("2.00"),
            "Sunrise Farm, Texas", false, "A",
        ...
        createListing(FARMER2_ID, vegetables, "Red Onions",
            ...
            "Onion", new BigDecimal("300.00"), new BigDecimal("40.00"), new BigDecimal("3.00"),
            "Sunrise Farm, Texas", false, "A",
        ...
        createListing(FARMER2_ID, vegetables, "Fresh Potatoes",
            ...
            "Potato", new BigDecimal("400.00"), new BigDecimal("32.00"), new BigDecimal("5.00"),
            "Sunrise Farm, Texas", false, "A",
        ...
        createListing(FARMER2_ID, vegetables, "Green Cabbage",
            ...
            "Cabbage", new BigDecimal("120.00"), new BigDecimal("30.00"), new BigDecimal("2.00"),
            "Sunrise Farm, Texas", false, "A",
        ...
        createListing(FARMER2_ID, fruits, "Golden Apples",
            ...
            "Apple", new BigDecimal("180.00"), new BigDecimal("150.00"), new BigDecimal("2.00"),
            "Sunrise Farm, Texas", false, "A",
        ...
        createListing(FARMER2_ID, fruits, "Fresh Oranges",
            ...
            "Orange", new BigDecimal("150.00"), new BigDecimal("80.00"), new BigDecimal("3.00"),
            "Sunrise Farm, Texas", false, "A",
        ...
        createListing(FARMER2_ID, fruits, "Ripe Bananas",
            ...
            "Banana", new BigDecimal("100.00"), new BigDecimal("50.00"), new BigDecimal("1.00"),
            "Sunrise Farm, Texas", false, "A",
        ...
        createListing(FARMER2_ID, fruits, "Sweet Mangoes",
            ...
            "Mango", new BigDecimal("60.00"), new BigDecimal("150.00"), new BigDecimal("2.00"),
            "Sunrise Farm, Texas", false, "A+",
        ...
        createListing(FARMER2_ID, organic, "Raw Organic Honey",
            ...
            "Honey", new BigDecimal("30.00"), new BigDecimal("420.00"), new BigDecimal("0.50"),
        ...
        createListing(FARMER2_ID, organic, "Organic Olive Oil",
            ...
            "Olive Oil", new BigDecimal("25.00"), new BigDecimal("890.00"), new BigDecimal("0.50"),
            "Sunrise Farm, Texas", true, "Premium",
        ...
        createListing(FARMER2_ID, pulses, "Red Lentils",
            ...
            "Lentils", new BigDecimal("200.00"), new BigDecimal("110.00"), new BigDecimal("2.00"),
            "Sunrise Farm, Texas", false, "A",
        ...
        createListing(FARMER2_ID, pulses, "Black Beans",
            ...
            "Beans", new BigDecimal("150.00"), new BigDecimal("130.00"), new BigDecimal("2.00"),
            "Sunrise Farm, Texas", false, "A",
        ...
        createListing(FARMER2_ID, pulses, "Chickpeas",
            ...
            "Chickpeas", new BigDecimal("180.00"), new BigDecimal("100.00"), new BigDecimal("2.00"),
            "Sunrise Farm, Texas", false, "A",
        ...
        createListing(FARMER2_ID, spices, "Fresh Ginger",
            ...
            "Ginger", new BigDecimal("50.00"), new BigDecimal("180.00"), new BigDecimal("0.25"),
            "Sunrise Farm, Texas", false, "A",
        ...
        createListing(FARMER2_ID, spices, "Fresh Garlic",
            ...
            "Garlic", new BigDecimal("80.00"), new BigDecimal("140.00"), new BigDecimal("0.50"),
            "Sunrise Farm, Texas", false, "A",
        ...
        createListing(FARMER2_ID, spices, "Fresh Turmeric",
            ...
            "Turmeric", new BigDecimal("40.00"), new BigDecimal("200.00"), new BigDecimal("0.25"),
            "Sunrise Farm, Texas", true, "A",
